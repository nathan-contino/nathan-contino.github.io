...
**Stack and Stem**: Most modern bikes use stems that position the handlebars at least a couple of inches in front of the stack. My Moonshiner uses a custom stem called the "ice cream stem" which holds your handlebars right on top like a scoop of ice cream on a waffle cone. It's hard to say how much the "zero reach" stem matters, but the handling on my moonshiner is superior to every other mountain bike I've ever ridden. I can whip my front wheel around extremely easily to dodge obstacles on the trail, cutting precise, surgical paths when I want to. And when I'm zooming down a hill, it doesn't feel too touchy. Is it the zero-reach? Is it the drop bars? All of that moonshine? I don't know, but it slaps.

{% include figure.html url="2024-08-09-the-moonshiner-review/28.webp" description="behold the zero-reach ice cream stem" %}
