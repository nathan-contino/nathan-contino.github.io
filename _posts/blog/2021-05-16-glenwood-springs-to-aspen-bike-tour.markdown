...
{% include figure.html url="may_21_bike_trip/mandarb_and_sully.webp" description="mandarb and sully" %}
...
{% include figure.html url="may_21_bike_trip/the_journey_really_begins.webp" description="the bikes looking fresh while Clem gets left behind in the RFTA parking lot" %}
...
{% include figure.html url="may_21_bike_trip/the_journey_begins.webp" description="probably should have noticed the angle of the rack while taking this photo" %}
...
{% include figure.html url="may_21_bike_trip/rack_problems.webp" description="rack problems" %}

# Carbondale

{% include figure.html url="may_21_bike_trip/sopris.webp" description="biking south towards the majestic mount sopris" %}
...
{% include figure.html url="may_21_bike_trip/thanks_bike_shop.webp" description="basalt bike & ski to the rescue!" %}
...
{% include figure.html url="may_21_bike_trip/french_toast.webp" description="the best french toast Meg has ever had 10/10" %}

{% include figure.html url="may_21_bike_trip/burrito.webp" description="one helluva delicious breakfast burrito 9.7/10" %}

Nicely done, SILO. We'll be back.

{% include figure.html url="may_21_bike_trip/art_path.webp" description="art path through carbondale" %}
...
{% include figure.html url="may_21_bike_trip/riding_out_of_carbondale.webp" description="bikey boi" %}
...
{% include figure.html url="may_21_bike_trip/baby_cows.webp" description="this baby cow's cuteness level was off the charts" %}
...
{% include figure.html url="may_21_bike_trip/meg_in_the_valley.webp" description="meg's enthusiasm for farms knows no bounds" %}

# Basalt

{% include figure.html url="may_21_bike_trip/horse_priority_bridge.webp" description="honestly pretty disappointed with the lack of horses on the trail" %}
...
{% include figure.html url="may_21_bike_trip/beer_and_rest.webp" description="enjoying a brew on the river" %}
...
{% include figure.html url="may_21_bike_trip/harmony.webp" description="donkeys, goats, sheep, horses, and cows all living in harmony" %}
...
{% include figure.html url="may_21_bike_trip/train_house.webp" description="nate, mandarb, & pullman - name a better trio, I dare you" %}
...
{% include figure.html url="may_21_bike_trip/aspen_first_glance.webp" description="so many shades of green and the first glimpse of aspen snowmass" %}
...
{% include figure.html url="may_21_bike_trip/prairie_dog.webp" description="one of the hundreds of prairie dogs we spotted. sneaky lil bois" %}
...
{% include figure.html url="may_21_bike_trip/aspen_slopes.webp" description="wandering around aspen left a strange desire to walk away from the people and up the mountain" %}
...
{% include figure.html url="may_21_bike_trip/near_aspen.webp" description="realizing that the entire trip on day 2 would be downhill" %}
...
{% include figure.html url="may_21_bike_trip/praise_the_sun.webp" description="the sunlight starts right on the outskirts of aspen. coincidence? i think not. praise the sun. praise ra." %}

We were treated to an absolutely gorgeous crisp morning.

{% include figure.html url="may_21_bike_trip/prairie_dog_paradise.webp" description="prairie dog paradise" %}
...
{% include figure.html url="may_21_bike_trip/turkey.webp" description="birb in a field, birb in a field, i am just a birb in a field" %}
...
{% include figure.html url="may_21_bike_trip/aspen_view.webp" description="looking back at aspen snowmass and wishing it didn't cost extra on the IKON pass" %}

{% include figure.html url="may_21_bike_trip/church.webp" description="church-house conversion in basalt" %}
...
{% include figure.html url="may_21_bike_trip/old_basalt_trail.webp" description="sully & mandarb ready to take on basalt" %}
...
{% include figure.html url="may_21_bike_trip/bridge.webp" description="cute bridge on the old snowmass/basalt trail" %}
...
{% include figure.html url="may_21_bike_trip/lizard.webp" description="artway lizard in carbondale" %}
...
{% include figure.html url="may_21_bike_trip/truss.webp" description="nice little beach area between carbondale and glenwood springs" %}
...
{% include figure.html url="may_21_bike_trip/white_and_red_and_green.webp" description="'it's like they ran out of red paint and just had to switch to white'" %}
...
{% include figure.html url="may_21_bike_trip/glenwood_canyon.webp" description="i-70 between vail and glenwood springs is absolutely wild" %}

# Epilogue

{% include figure.html url="may_21_bike_trip/fin.webp" description="a happy meg knowing that casey brewing is just minutes away" %}
