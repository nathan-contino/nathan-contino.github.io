...
{% include figure.html url="2023_08_06/0.png" description="burrito" %}
...
{% include figure.html url="2023_08_06/2.png" description="loading up our haul of pies" %}

We stopped for a pie break next to a very cool gazebo with a gorgeous view of a defunct rail bridge.

{% include figure.html url="2023_08_06/3.png" description="rail bridge, everybody pie" %}
...
{% include figure.html url="2023_08_06/4.png" description="missed milk moment" %}
...
{% include figure.html url="2023_08_06/5.png" description="fuel" %}

We (politely!) passed some horses on the cycle path.

{% include figure.html url="2023_08_06/6.png" description="rolling hills" %}

{% include figure.html url="2023_08_06/7.png" description="can you count all of these sheeps" %}

{% include figure.html url="2023_08_06/8.png" description="a crop, or a meadow? you be the judge" %}

We creatively dealt with roadwork and diversions.

{% include figure.html url="2023_08_06/9.png" description="creativity..." %}

{% include figure.html url="2023_08_06/10.png" description="when faced with challenges" %}

We spotted a tiny horse.

{% include figure.html url="2023_08_06/11.png" description="lil sebastian" %}
...
{% include figure.html url="2023_08_06/12.png" description="more sheep hills" %}

{% include figure.html url="2023_08_06/13.png" description="climbing the sheep hills" %}

{% include figure.html url="2023_08_06/14.png" description="sheep mountains" %}
...
{% include figure.html url="2023_08_06/15.png" description="driveway to a random farmer's house" %}

{% include figure.html url="2023_08_06/16.png" description="maybe a sheep path" %}

{% include figure.html url="2023_08_06/17.png" description="not even a sheep path" %}

{% include figure.html url="2023_08_06/18.png" description="nice views" %}
...
{% include figure.html url="2023_08_06/19.png" description="my god, it's full of flies" %}
...
{% include figure.html url="2023_08_06/20.png" description="what used to be a forest" %}
...
{% include figure.html url="2023_08_06/21.png" description="a campsite that is not full of imminent death" %}
...
{% include figure.html url="2023_08_06/22.png" description="views of the logging operation we passed through last night" %}

{% include figure.html url="2023_08_06/23.png" description="BEWARE" %}

{% include figure.html url="2023_08_06/24.png" description="PNW vibes" %}

{% include figure.html url="2023_08_06/25.png" description="there's a lot more cattle grids where this came from" %}

Along the way, we appreciated the mushrooms and wild rabbits of the moors.

{% include figure.html url="2023_08_06/26.png" description="mushroom appreciation post" %}

{% include figure.html url="2023_08_06/27.png" description="can you spot the monty python white rabbit?" %}
...
{% include figure.html url="2023_08_06/28.png" description="pedestrian bridge to peebles" %}
...
{% include figure.html url="2023_08_06/29.png" description="rail trail to interleithen passes straight through a golf course" %}
...
{% include figure.html url="2023_08_06/30.png" description="stream washing" %}

Our day proceeded swimmingly. The backroads we routed along turned out to be beautiful and incredibly low traffic.

{% include figure.html url="2023_08_06/31.png" description="shrubby hills have colorado vibes" %}

{% include figure.html url="2023_08_06/32.png" description="tree farm" %}

{% include figure.html url="2023_08_06/33.png" description="cresting our biggest ascent of the day" %}

{% include figure.html url="2023_08_06/34.png" description="the view at the top of the hill" %}

{% include figure.html url="2023_08_06/35.png" description="a reservoir" %}
...
{% include figure.html url="2023_08_06/36.png" description="snacking and/or threatening children in the park" %}
...
{% include figure.html url="2023_08_06/37.png" description="fresh out' da womb piglets" %}
...
{% include figure.html url="2023_08_06/38.png" description="simple, cheap, effective campsite, 10/10" %}
...
{% include figure.html url="2023_08_06/39.png" description="peak views" %}

But the best part was the descent: at least 5 miles of long, rolling, relaxing downhill, and next to no traffic.

{% include figure.html url="2023_08_06/40.png" description="this, but for 5 miles" %}
...
{% include figure.html url="2023_08_06/41.png" description="the land of peg" %}
...
{% include figure.html url="2023_08_06/42.png" description="ENG" %}
