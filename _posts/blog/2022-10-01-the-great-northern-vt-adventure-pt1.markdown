...
{% include figure.html url="2022_10_01/14_vt_postcard.webp" description="the whole trip was beautiful but this view probably takes the cake" %}

# Shipping Out

{% include figure.html url="2022_10_01/01_gear.webp" description="most of the gear & clothes" %}
...
{% include figure.html url="2022_10_01/02_littleton.webp" description="gotta stop for a foggy littleton pic, 3 minutes on the road" %}
...
{% include figure.html url="2022_10_01/04_first_cows.webp" description="nate won the bet on when we'd see the first cows" %}

{% include figure.html url="2022_10_01/05_nate_bikey_boi.webp" description="the rail trail crosses mostly small side roads which is nice" %}

{% include figure.html url="2022_10_01/06_corn_rail_trail.webp" description="foggy corn" %}
...
{% include figure.html url="2022_10_01/07_bridge_rail_trail.webp" description="massive rail trail bridge about 200 feet above the river" %}
...
{% include figure.html url="2022_10_01/03_bath_waterfall.webp" description="you don't get this view from the highway" %}

# Second Breakfast

{% include figure.html url="2022_10_01/08_vt.webp" description="thankful that nate begrudgingly stopped for a pic on the side of the busy road" %}
...
{% include figure.html url="2022_10_01/09_tuttles.webp" description="tuttles is the true wells river experience" %}
...
{% include figure.html url="2022_10_01/20_xvt_offshoot.webp" description="xvt trail looking suprisingly cute right after hopping off 302" %}
...
{% include figure.html url="2022_10_01/10_dirt_baby.webp" description="back on that classic VT dirt" %}
...
{% include figure.html url="2022_10_01/11_lakes.webp" description="groton state forest hitting us with the views" %}

{% include figure.html url="2022_10_01/12_rock_thoughts.webp" description="snack break rock thoughts" %}

{% include figure.html url="2022_10_01/13_more_dirt.webp" description="the route through the state forest had a mix of state forest roads and rail trail - aka perfection" %}
...
{% include figure.html url="2022_10_01/15_hill.webp" description="'meg, there's a waterfall up this massive hill that we don't need to go up' - nate" %}

{% include figure.html url="2022_10_01/16_the_waterfall.webp" description="'sick, totally worth it. i'm sure we won't see any other waterfalls this trip' - meg" %}
...
{% include figure.html url="2022_10_01/17_pizza_wings.webp" description="who knew general store calzones are pure bike fuel?" %}
...
{% include figure.html url="2022_10_01/18_shroom_king.webp" description="mushroom friends at the campsite" %}
...
{% include figure.html url="2022_10_01/19_camp.webp" description="camp #1 - onion river campgrounds" %}
