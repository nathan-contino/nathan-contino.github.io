...
Note: devices that leave the home, like my laptop and my phone, end up with
...
> In the "Internet" tab, set both "DNS Servers" inputs to the IP address of
  ...
  ghost numbers, and (amusingly) `main.rr.com`, despite the fact that I
...
- Astral Codex Ten
- Climate Town Videos
- Continuing Ed (Snowden)
- cosmosurfer's blog
- CyclingAbout Videos
- Docs for Developers
- FreshRSS releases
- Granola Shotgun
- James Hoffmann Videos
- Jamie Tanna
- Jay Foreman Videos
- Julia Evans
- Noah Caldwell-Gervais Videos
- Not Just Bikes Videos
- RedLetterMedia Videos
- Rivendell Blahg
- Rolling Existence
- Rolling Existence Videos
- Steve Gattuso
- Stratechery
