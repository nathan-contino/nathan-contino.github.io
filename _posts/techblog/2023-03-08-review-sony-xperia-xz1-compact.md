...
- I immediately set up [LineageOS 19](https://forum.xda-developers.com/t/rom-lineageos-17-18-19-unofficial-update-2023-04-01.4308295/) for the latest space-efficient Android OS and security updates. *Note: if you plan on following in my footsteps, consider [backing up your unique Sony DRM keys](https://forum.xda-developers.com/t/xz1c-xz1-xzp-temp-root-exploit-to-backup-drm-keys-implemented.3795510/page-88#post-88023479) so that you can return to stock firmware with full camera functionality.*
